...
const STORAGE_KEY = 'gachiakuta_read_chapters';
      ...
      <div className="bg-white dark:bg-[#0f0f0f] border-b border-gray-100 dark:border-white/5 py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-wrap gap-2 mb-4">
            {['Action', 'Adventure', 'Shounen', 'Dark Fantasy', 'Survival'].map(g => (
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4">
            Rudo is a boy from the Slums living below a massive floating city. Falsely accused of murder by nobles, he is thrown into the Pit — a giant landfill where criminals and outcasts fight to survive. There he awakens the power of a Reaper: the ability to bring discarded objects to life as weapons.
          </p>
          <div className="flex flex-wrap gap-6 text-xs text-gray-500 dark:text-gray-500">
            <span><strong className="text-gray-700 dark:text-gray-300">Author:</strong> Kei Urana</span>
            ...
            <span><strong className="text-gray-700 dark:text-gray-300">Started:</strong> February 2022</span>
          </div>
        </div>
      </div>
