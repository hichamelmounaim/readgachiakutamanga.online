        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="max-w-md">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-600">
              Fan Project. Not affiliated with Kei Urana or Weekly Shōnen Magazine.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li><a href="https://www.readkingdommanga.online/" className="hover:text-bb-blue transition-colors">Kingdom Manga</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li><a href="mailto:support@readgachiakutamanga.online" className="hover:text-bb-blue transition-colors">Contact</a></li>
              </ul>
            </div>
          </div>
        </div>
